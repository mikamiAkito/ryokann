                ...
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-10" src="/storage/{{$posts->image}}" alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-10" src="/storage/{{$posts->image2}}" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-10" src="/storage/{{$posts->image3}}" alt="Third slide">
                        </div>
                    </div>
