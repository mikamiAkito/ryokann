    ...
    <body>
        ...
        <form action="/posts" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3 text-center">
                ...
                <input type="date" class="form-control ml-auto mr-auto" id="exampleFormControlInput6" name="date_strat" value="{{ old('date_strat') }}">
            </div>
            <div class="mb-3 text-center">
                <label for="exampleFormControlInput1" class="form-label">受付終了日</label>
                <input type="date" class="form-control ml-auto mr-auto" id="exampleFormControlInput6" name="date_end" value="{{ old('date_end') }}">
            </div>
            <div class="mb-3 text-center">
                <label for="exampleFormControlTextarea1" class="form-label">内容</label>
                <textarea class="form-control ml-auto mr-auto" id="exampleFormControlTextarea5" rows="3" name="explanation">{{ old('explanation') }}</textarea>
            </div>
            <div class="mb-3 text-center">
